...
import com.evacipated.cardcrawl.mod.bard.powers.DiscordantVoicePower;
...
public class DiscordantVoice extends AbstractBardCard
{
    ...
    {
        addToBottom(new ApplyPowerAction(p, p, new DiscordantVoicePower(p, magicNumber), magicNumber));
    }
